...
- ![app_image](../_static/ico/opentasks.ico) **[OpenTasks](https://f-droid.org/de/packages/org.dmfs.tasks/)**: Eine Aufgabenmanager-App, mit der Sie Ihre ToDo-Liste nach Dringlichkeit, Status, Zeitrahmen usw. kategorisieren können.
...
- ![app_image](../_static/ico/openoffice.ico) **[LibreOffice & OpenOffice](https://f-droid.org/de/packages/at.tomtasche.reader/)**: Lesen und bearbeiten Sie Dokumente, die mit LibreOffice oder OpenOffice erstellt wurden, auch unterwegs mit OpenDocument Reader
- ![app_image](../_static/ico/collabora.ico) **[Collabora](https://www.collaboraoffice.com/collabora-office-android-ios/)**: Alternative zu GoogleDocs. Anzeige und Bearbeitung von Dokumenten, die z.B. über Nextcloud synchronisiert werden.
