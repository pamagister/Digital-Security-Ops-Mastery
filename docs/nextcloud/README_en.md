...
1. ![app_image](../_static/ico/fdroid.ico) **F-Droid**: Alternative Playstore with generally secure open source apps
1. ![app_image](../_static/ico/nextcloud.ico) **Nextcloud**: Synchronization client for the Nextcloud app, basis for syncing files, contacts, calendars, tasks, etc.
